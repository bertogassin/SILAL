...
import { ledgerHolds } from "@/lib/si/ledger";
...
export function SettingsScreen() {
  ...
  const holds = ledgerHolds(ledger);
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <p className={holds ? "text-sm text-wool" : "text-sm text-garnet"}>{holds ? t("sec.ok") : t("sec.bad")}</p>
