...
import { FOUNDATION } from "@/lib/si/foundation";
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <ul className="divide-y divide-border rounded-2xl border border-border text-sm">
        ...
        <li className="flex justify-between px-4 py-3">
          <span>interestBps</span>
          <span className="tabular text-wool">{FOUNDATION.interestBps}</span>
        </li>
        <li className="flex justify-between px-4 py-3">
          <span>mintAfterGenesis</span>
          <span className="tabular text-wool">{String(FOUNDATION.mintAfterGenesis)}</span>
        </li>
      </ul>
