...
export function WalletScreen() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link to="/house" className="si-door p-3">
          <div className="font-display">{t("bank.pot")}</div>
          <p className="mt-1 text-xs text-muted-foreground">{t("bank.potHint")}</p>
        </Link>
        <Link to="/chronicle" className="si-door p-3">
          <div className="font-display">{t("nav.chronicle")}</div>
          <p className="mt-1 text-xs text-muted-foreground">{t("chr.hint")}</p>
        </Link>
      </div>
